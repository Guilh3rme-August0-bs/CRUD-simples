export const Button = ({ children, buttonClick, variant }) => {
    ...
    const variantClasses = {
        primary: "bg-[#1d7b4b] cursor-pointer mt-8 w-40 p-2 rounded-sm hover:bg-green-500 font-sans font-semibold text-white text-lg max-[599px]:mt-2 mb-2",
    ...
    return (
        <div className="flex flex-col p-3 max-[599px]:p-2">
